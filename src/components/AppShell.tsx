    ...
    <header style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10, flexShrink: 0 }}>
        ...
        <span
          ...
          style={{ fontFamily: "var(--font-mono)", fontSize: 11, color: "var(--mid)", cursor: "pointer", letterSpacing: ".08em", transition: "color .2s" }}
        >
          {sotto.modeLabel}
        </span>
        ...
        <div
          ...
          style={{
            fontFamily: "var(--font-mono)", fontSize: 11.5, padding: "6px 11px", borderRadius: 2,
            border: "1px solid var(--line)", color: "var(--mid)", cursor: "pointer", transition: "all .2s",
          }}
        >
          SDK
        </div>
        ...
        {isConnected && address ? (
          <div style={{ display: "flex", alignItems: "center", gap: 7, padding: "7px 13px", borderRadius: 2, border: "1px solid var(--line)", cursor: "pointer", transition: "border-color .2s" }}>
            <span style={{ width: 6, height: 6, borderRadius: "50%", background: "var(--green)", animation: "float 2.4s ease-in-out infinite" }} />
...
function SDKDrawer() {
  ...
  return (
    <>
      ...
      <div onClick={(e) => e.stopPropagation()} style={{ position: "fixed", right: 0, top: 0, bottom: 0, width: 480, zIndex: 71, background: "var(--surface)", borderLeft: "1px solid var(--line)", display: "flex", flexDirection: "column", animation: "slideInR .3s cubic-bezier(.22,.85,.2,1) both", transition: "background .4s, border-color .4s" }}>
        <div style={{ padding: "24px 26px 18px", borderBottom: "1px solid var(--line)", display: "flex", alignItems: "center", justifyContent: "space-between", flexShrink: 0 }}>
          ...
          <div onClick={sotto.toggleSdk} style={{ width: 28, height: 28, display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", color: "var(--mid)", fontSize: 18 }}>✕</div>
        </div>
...
function NotifDrawer() {
  ...
  const notifs = [
    ...
    { title: "0x4f29…b2A1 claimed their allocation", time: "18 min ago", dot: "var(--green)", glow: true },
    { title: "0xc1aE…9Fd0 claimed their allocation", time: "1h ago", dot: "var(--green)", glow: false },
    ...
    <>
      ...
      <div onClick={(e) => e.stopPropagation()} style={{ position: "fixed", right: 0, top: 56, bottom: 0, width: 360, zIndex: 71, background: "var(--surface)", borderLeft: "1px solid var(--line)", display: "flex", flexDirection: "column", animation: "slideInR .28s cubic-bezier(.22,.85,.2,1) both" }}>
        <div style={{ padding: "22px 24px 16px", borderBottom: "1px solid var(--line)", display: "flex", alignItems: "center", justifyContent: "space-between", flexShrink: 0 }}>
          ...
          <div onClick={sotto.markAllRead} style={{ fontFamily: "var(--font-mono)", fontSize: 11, color: "var(--accent)", cursor: "pointer" }}>Mark all read</div>
        </div>
